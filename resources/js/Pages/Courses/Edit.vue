                        ...
                        <div class="card-header bg-white border-bottom py-3 px-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold text-dark">{{ __('Edit Course') }}</h5>
                                        <p class="mb-0 text-muted small">{{ course.slug }} | {{ __('Update curriculum and settings.') }}</p>
                                    </div>
                                </div>
                                <span class="badge bg-success-subtle text-success rounded-pill px-3 py-2 fw-bold small border border-success-subtle">{{ course.status.toUpperCase() }}</span>
                            </div>
                        </div>
